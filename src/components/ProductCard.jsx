...
import PaymentPage from './PaymentPage'; // Make sure this import points to the correct file
...
const ProductCard = ({ title, price, features, id, isPopular, upiId }) => {
  ...
  return (
    <>
      ...
      {isPaymentPageOpen && <PaymentPage upiId={upiId} onClose={handleClosePaymentPage} />}
    </>
  );
};
